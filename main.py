...
packages = ['pyfiglet', 'requests', 'colorama', 'pytz']
...
white = Fore.WHITE
system("clear")
auth = input(f"{yellow}Nhập Token Của Bạn: {red}")
	...
	if response != '':
		...
		if parser['code'] == 401:
			...
			if "apiError" in str(backend_data):
				...
				ketik(f"{red}━━━━━━━━━{green}━━━━━━━━━━━━━━{red}━━━━━━━━━")
				ketik(f"""\33[0;34;44m\33[1;37m ✔ \33[1;34m\33[0m\33[   {blue}Số {green}{logs}{blue} Tiền {yellow}Đã Thêm Vào Tài Khoản.""")
				chat = backend_data['Logs']
				uang= chat[len(chat)-1]['Message'].split()[5]
				ketik(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━")
				ketik(f"➤➤➤ {yellow}Tổng Thu Nhập Của Bạn Là {red}Rp:{green}{uang}")
				ketik(f"{red}━━━━━━━━━{green}━━━━━━━━━━━━━━{red}━━━━━━━━━")
...
def ketik(c):
    for e in c + "\n" :
        ...
        sys.stdout.flush()
        sleep(0.002)
ketik("SCRIPT BY: NGUYEN MINH NHAT (ROSIE)")   
system("clear")
...
{red}╚═╝  ╚═══╝╚═╝     ╚═╝╚═╝  ╚═══╝       ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝""")
ketik(f"\33[36;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"""{white} {red}[{white}<{green}/{white}>{red}]{white} Founder: {green}Nguyen Minh Nhat{white} - Facebook: {green}Nguyen Minh Nhat (Rosie)""")
ketik(f"""{white} {red}[{white}<{green}/{white}>{red}]{white} Script: {green}BUS SIMULATOR INDONESIA{white} - Version: {green}2.0""")
ketik(f"\33[36;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"""{white} {red}[{white}<{green}/{white}>{red}]{white}{green} ĐƯỢC NGUYÊN CỨU VÀ PHÁT TRIỂN (BETA)""")
ketik(f"""{white} {red}[{white}<{green}/{white}>{red}]{white}{green} CẢM ƠN BẠN ĐÃ SỬ DỤNG DỊCH VỤ ROSIETEAM.NET""")
ketik(f"\33[36;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
def mxx():
	...
	if response != '':
		...
		if parser['code'] == 401:
			...
			if "apiError" in str(backend_data):
				...
				id= gcc['TitleInfo']
				you= id['DisplayName']
				ketik(f"{white}    {red}[{white}<{green}/{white}>{red}]{white} Tổng Số Tiền: {green}{money}       {white}    - ID Của Bạn: {green}{you}")
				
ketik(f"{white}                    {red}[{white}<{green}/{white}>{red}]{white}Thông Tin Tài Khoản{red}[{white}<{green}/{white}>{red}]{white}")				
def hack():
	mxx()
...
hack()
ketik(f"\33[36;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"{white}{red}[{white}<{green}/{white}>{red}]{white} Tất Cả Chế Độ:")
...
ketik(f"{yellow}[{red}4{yellow}] {green}Thoát")

contoh = input (f"{white}{red}[{white}<{green}/{white}>{red}]{white} Chọn Chế Độ: ")
if contoh =="1":
   jum = int(input(f"{yellow}Số Lượng Nuyul:{red} "))
   ngopi()
elif contoh =="2":
   haya = int(input(f"{yellow}Số Lượng Nuyul:{red} "))
   ngopii()
elif contoh =="3":
     gugun = int(input(f"{yellow}Số Lượng Nuyul:{red} "))
     crot()
elif contoh =="4":    
     ketik(f"{red}[{white}<{green}/{white}>{red}]{white} Đã Thoát Tool Thành Công :)")
     sys.exit()